...
/*   Updated: 2020/07/01 10:01:25 by lumeyer          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft {
	...
	class base_dq_iterator
	{
		...
		public:
			...
			friend inline bool			operator<(base_dq_iterator<Ta, A> a, base_dq_iterator<Tb, B> b) {
				...
				long long shift_a = a.circular_clamp(diff_a, 0, a.dq->_capacity);
				long long shift_b = a.circular_clamp(diff_b, 0, a.dq->_capacity);
	...
	// clang++ mangled name bug requires this definition to go outside the base dq iter class
	template <typename Ta, typename Tb, bool A, bool B>
	inline bool			operator!=(base_dq_iterator<Ta, A> a, base_dq_iterator<Tb, B> b) {
		return (a.head != b.head);
	}
